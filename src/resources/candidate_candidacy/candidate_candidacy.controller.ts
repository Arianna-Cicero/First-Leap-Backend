...
export class CandidateCandidacyController {
  constructor(private readonly candidateCandidacyService: CandidateCandidacyService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCandidateCandidacyDto: UpdateCandidateCandidacyDto) {
    return this.candidateCandidacyService.update(+id, updateCandidateCandidacyDto);
  }
