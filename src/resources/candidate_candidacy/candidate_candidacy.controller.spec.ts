...
describe('CandidateCandidacyController', () => {
  let controller: CandidateCandidacyController;
  ...
  beforeEach(async () => {
    ...
    controller = module.get<CandidateCandidacyController>(CandidateCandidacyController);
  });
